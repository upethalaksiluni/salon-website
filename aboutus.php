...
<?php
// index.php
// Define the path to the aboutus.dat file
$aboutusFile = "aboutus.dat"; // Adjust the path to your .dat file if needed
$aboutusContent = '';

// Check if the file exists and is readable
if (file_exists($aboutusFile) && is_readable($aboutusFile)) {
    // Read the content of the aboutus.dat file
    $aboutusContent = file_get_contents($aboutusFile);
} else {
    $aboutusContent = 'Error loading aboutus content from aboutus.dat.';
}
?>
...
<head>
    ...
    <script src="assets/js/vendor/modernizr-3.5.0.min.js"></script>
        ...
        <?php
            $cssFiles = ["headercss.dat", "aboutuscss.dat"];
...
<body>
    ...
    <?php
      ...
      $jsFiles = ["headerjs.dat", "aboutusjs.dat"];
